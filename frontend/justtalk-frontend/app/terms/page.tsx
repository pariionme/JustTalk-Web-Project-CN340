  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-[#3D3D3D] mb-8">Terms of Service</h1>
        
        <div className="space-y-6 text-[#3D3D3D]">
          <section>
            <h2 className="text-xl font-semibold mb-3">1. Acceptance of Terms</h2>
            <p className="leading-relaxed">
              By accessing and using JustTalk, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to these terms, please do not use our service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              You agree to use JustTalk only for lawful purposes and in a way that does not infringe the rights of, restrict or inhibit anyone else&apos;s use and enjoyment of the service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              You retain ownership of any content you submit, post or display on or through JustTalk. By submitting content, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, and distribute such content.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              If you have any questions about these Terms, please contact us at support@justtalk.com.
            </p>
          </section>
        </div>
      </main>
